...
static void setup(LucyApp& app, Engine* engine, View* finalView, Scene* finalScene) {
    ...
    mat4f s = mat4f::scaling(float3 {FBO_WIDTH, FBO_HEIGHT, 1});
    tcm.setTransform(tcm.getInstance(app.hblurQuad), s);
    tcm.setTransform(tcm.getInstance(app.vblurQuad), s);
    ...
    app.reflection.view->setRenderTarget(*engine, app.reflection.color, app.reflection.depth, 0);
    ...
    app.primary.view->setRenderTarget(*engine, app.primary.color, app.primary.depth, 0);
    ...
    app.hblur.view->setRenderTarget(*engine, app.hblur.color, nullptr, 0);
    ...
    app.vblur.view->setRenderTarget(*engine, app.vblur.color, nullptr, 0);
